...
echo "  3. Verify proof:  ./target/release/nova_poc verify data/run_k50240.json --weights1-path data/w1_16x50240.bin"
echo "  Or verify without Freivalds: ./target/release/nova_poc verify data/run_k50240.json --skip-freivalds"
